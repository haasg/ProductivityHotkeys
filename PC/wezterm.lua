...
--   Ctrl-a (leader)  = multiplexer: workspaces, tabs, splits
--   Space            = Neovim leader (inside nvim)
--   Ctrl-h/j/k/l     = universal pane movement (vim splits + wezterm panes)
...
-- ── Multiplexer keys (leader = Ctrl-a) ──────────────────────
...
-- ── Seamless Ctrl-h/j/k/l across wezterm panes and vim splits ──
...
table.insert(config.keys, nav_key('h', 'Left'))
table.insert(config.keys, nav_key('j', 'Down'))
table.insert(config.keys, nav_key('k', 'Up'))
